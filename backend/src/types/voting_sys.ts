...
export type VotingSys = {
  ...
  instructions: [
    {
      ...
      discriminator: [47, 187, 164, 138, 61, 111, 218, 96];
      accounts: [
        {
          name: "electionData";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [246, 38, 228, 128, 103, 220, 118, 246];
      accounts: [
        {
          name: "electionData";
          writable: true;
    ...
    {
      name: "changeStage";
      discriminator: [26, 65, 114, 165, 92, 184, 26, 49];
      accounts: [
        {
          name: "electionData";
          writable: true;
    ...
    {
      name: "createElection";
      discriminator: [190, 206, 84, 42, 83, 221, 248, 249];
      accounts: [
        {
          name: "electionData";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [66, 23, 51, 52, 90, 243, 197, 121];
      accounts: [
        {
          name: "electionData";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [138, 188, 148, 59, 20, 173, 10, 46];
      accounts: [
        {
          name: "electionData";
          writable: true;
  ...
  accounts: [
    {
      name: "candidateData";
      discriminator: [242, 114, 27, 163, 254, 113, 100, 155];
    },
    {
      name: "electionData";
      discriminator: [83, 132, 137, 223, 164, 5, 215, 85];
    },
    {
      name: "voterData";
      discriminator: [188, 23, 235, 160, 38, 227, 251, 114];
    }
  ];
  errors: [
    {
